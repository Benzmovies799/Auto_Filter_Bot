...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1001677602829 -1002216420190 -1001830080813")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1001677602829 -1002216420190 -1001830080813")# Channels for force sub (make sure bot is admin)
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/benzmawa') # Owner link for the bot
